...
<head>
	<meta charset="UTF-8">
	<title>Submitted Payment Information</title>
	<style>
...
<body>
	<div class="box">
		<form autocomplete="off" action ="paymentSubmission.php" method="POST">
			<h2 style ="background: #101820;" >Submission Complete</h2>
