...
function fetch_data()
{
    ...
    $query3 = "SELECT * FROM paymentconfirmed where stud_id = $id";
...
{  
     ...
     $obj_pdf->SetTitle("Registration Form");  
   ...
   $content .= '</table>'; 
    $content .= '  
    <h1 style = "text-align: center; font-size: 20px; font-weight: 1000px;">YOU ARE NOW, OFFICIALLY ENROLLED!</h1>
    ';
