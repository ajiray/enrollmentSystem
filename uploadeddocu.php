...
input[type="submit"]:active 
{
    ...
    <body>
        ...
        <h1 style ="text-align:center;color:#f4b41a;">Uploaded Documents</h1>
		<h4>
        <?php 
      
	$sql = "SELECT DocumentName,stud_id FROM temp_images where stud_id = '$studid'";
