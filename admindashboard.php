   ...
   <div class="wrapper">
       <div class="sidebar">
           ...
           <ul>
               ...
               <li><a href="./signupadmin.php" target="iframe_a"><i class="fas fa-address-card"></i>Sign up New User</a></li>
               <li><a href="./listofuser.php" target="iframe_a"><i class="fas fa-cash-register"></i>List of Accounts</a></li>
           </ul> 
